...
<form action="feedback.php" method="post" align="center">
	<fieldset>
		<legend style="color:#4F3810">Contactați-ne dacă întâmpinați vreo problemă!</legend>
		<label>Nume:</label>
		<input type=text name=fNume required=required><br><br>
		<label>Prenume:</label>
		<input type=text name=fPrenume><br><br>
		<label>Email:</label>
		<input type=text name=fEmail required=required><br><br>
		<label>Ce problemă aveți?</label>
		<textarea name=fMesaj rows="4" cols="50" required>
		</textarea>
