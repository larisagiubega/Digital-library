...
<br>
<form action="imprumutaCarte.php" method="post" align="center">
	<fieldset>
		<legend style="color:#4F3810">Ce carte doriți să împrumutați?</legend>
		<label>Nr. cărții de împrumutat:</label>
