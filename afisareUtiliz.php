...
<hr>
<button onclick="window.location.href = 'imprumutaCarteForm.php';" class="button2">Împrumutați carte</button>
<button onclick="window.location.href = 'returneazaCarteForm.php';" class="button2">Returnați carte</button>
