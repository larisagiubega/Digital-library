...
<hr>
<button onclick="window.location.href = 'stergeCarteForm.php';" class="button2">Ștergeți carte</button>
<button onclick="window.location.href = 'inserareCarteForm.html';" class="button2">Inserați carte</button>
